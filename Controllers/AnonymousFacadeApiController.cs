...
namespace API_Web_For_Flights_Project.Controllers
{
    ...
    public class AnonymousFacadeApiController : ApiController
    {
        ...
        /// <summary>
        /// Get List of Flights By Origin Country code
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [ResponseType(typeof(List<Flight>))]
        ...
        /// <summary>
        /// Get List of Flights By Destination Country code
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [ResponseType(typeof(List<Flight>))]
        ...
        /// <summary>
        /// Get List of Flights By Depatrure Date
        /// </summary>
        ...
        /// <summary>
        /// Get List of Flights By Landing Date
        /// format:
